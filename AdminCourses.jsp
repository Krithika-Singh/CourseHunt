...
<center><font size = "+3" color = "white"><h1>Offered Courses</h1></font></center><br>
<div id="table">
<table border=1 align = "center">
	...
	<c:forEach  items="${Course}" var="Inst">
        <tr bgcolor = "#e4decd" align = "center">
				
				<td style = "color:black;">${Inst.courseId}</td>
				<td style = "color:black;">${Inst.courseName}</td>
